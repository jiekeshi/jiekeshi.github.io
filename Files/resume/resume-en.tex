...
% \begin{tabular*}{16.2cm}{l@{\extracolsep{\fill}}}
  ...
  % \multicolumn{1}{p{16.65cm}}{
    \vspace{-0.6cm}
    \begin{enumerate}
      \item Chen Gong, Zhou Yang, Yunpeng Bai, \underline{Jieke Shi}, Arunesh Sinha, Bowen Xu, David Lo, Xinwen Hou, and Guoliang Fan. ``\textbf{Curiosity-Driven and Victim-Aware Adversarial Policies}." 2022 39th Annual Computer Security Applications Conference (ACSAC). (15 pages, Technical Paper, \textcolor{red}{\faMedal Honorable Mention Award}.) [\link{https://jiekeshi.github.io/Files/ACSAC_2022.pdf}{PDF}][\link{https://github.com/soarsmu/Curiosity_in_Adversarial_Policy}{Code}]
      \item \underline{Jieke Shi}, Zhou Yang, Bowen Xu, Hong Jin Kang, and David Lo. ``\textbf{Compressing Pre-trained Models of Code into 3 MB}." 2022 IEEE/ACM 37th International Conference on Automated Software Engineering (ASE). (12 pages, Research Paper, \textcolor{red}{\faMedal Nominated for ACM SIGSOFT Distinguished Paper Award}.) [\link{https://jiekeshi.github.io/Files/ASE_2022.pdf}{PDF}][\link{https://github.com/soarsmu/Compressor}{Code}]
      \item Chengran Yang, Bowen Xu, Ferdian Thung, Yucen Shi, Ting Zhang, Zhou Yang, Xin Zhou, \underline{Jieke Shi}, Junda He, DongGyun Han, and David Lo. ``\textbf{CAnswer Summarization for Technical Queries: Benchmark and New Approach}." 2022 IEEE/ACM 37th International Conference on Automated Software Engineering (ASE). (12 pages, Research Paper.) [\link{https://arxiv.org/pdf/2209.10868.pdf}{PDF}][\link{https://github.com/TechSumBot/TechSumBot}{Code}]
...
\item Sub-reviewer of ICSE 2022, ICECCS 2022, CAIN 2022, SE4RAI 2022, IJCAI 2022, ASE 2022, SANER 2023 conference.
      \end{itemize}}
\end{tabular*}
